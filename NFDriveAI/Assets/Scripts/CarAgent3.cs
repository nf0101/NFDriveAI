...
public class CarAgent3 : MonoBehaviour
{
    ...
    private string filePath => Path.Combine(Application.dataPath + "\\Learning\\Agent1\\", "Agent1_1.json");
